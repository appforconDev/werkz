...
// (Task 37 B: the steel beam under it was removed — it didn't read well in the
// card; the register stands alone, as before 884907c. The beam asset + pipeline
// are kept for a possible season-polish return.)
